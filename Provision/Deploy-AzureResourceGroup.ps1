...
Param(
	...
	[string] [Parameter(Mandatory=$true, ParameterSetName='RunArmTemplate')] $ApplicationInsightsLocation,
...
if ($HostType -ne "") {
	...
	if($ApplicationInsightsLocation -ne "") {
		$extraParameters.Add('applicationInsightsLocation', $ApplicationInsightsLocation)
	}
